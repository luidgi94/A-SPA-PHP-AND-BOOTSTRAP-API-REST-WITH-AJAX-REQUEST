  ...
  function showSearchForm(id) {
    ...
    document.getElementById('categorySearch').value = "toutes";
    document.getElementById('multi_store_tfSearch').checked = true;
    ...
    switch(id){
      ...
      case 'name_search':
        ...
        document.getElementById('divMulti_store').style.display = "none";
      ...
      case 'all_search':
        ...
        document.getElementById('divSize').style.display = "block";
        document.getElementById('divCategory').style.display = "block";
        document.getElementById('divMulti_store').style.display = "block";
...
function search(){
    ...
    var size = document.getElementById("sizeSearch").value
    if (document.getElementById("multi_store_tSearch").checked == true ){
        var multi_store = document.getElementById("multi_store_tSearch").value 
    }
    else if (document.getElementById("multi_store_fSearch").checked == true ){
        var multi_store = document.getElementById("multi_store_fSearch").value 
    }
    else{
        var multi_store = document.getElementById("multi_store_tfSearch").value 
    }
    ...
    console.log('valeur' + name + city + size + multi_store + category)
              ...
              ////// FORM UPDATE : 
                  ...
                  error: function () {
                    let liste = document.getElementById('item_test');
                    liste.innerHTML = '<p><h1> MINCE !<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg" alt=""> <h1> </p> <br><p><h2> Désolé mais aucun magasin ne correspond à la recherche ....</h2> </p>'
                      // Fail message
                    ...
                    //   //clear all fields
                    //   $("#updateFormPost"+ id).trigger("reset");
                  },
                  complete: function () {
                      // setTimeout(function () {
